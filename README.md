[![Tests](https://github.com/Flatren/python-core-homework/actions/workflows/python-app.yml/badge.svg?branch=master)](https://github.com/Flatren/python-core-homework/actions/workflows/python-app.yml)
